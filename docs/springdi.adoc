...
Edit the `VetsResource.java` class file in `src/main/java/org/acme/rest` to inject the VetsService(CDI bean). Add the following code under the `// TODO: Inject CDI Bean` comment:
