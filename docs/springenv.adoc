...
Simply selectce and the whole block is copied to your clipboard, ready to be pasted with kbd:[CTRL+V] (or kbd:[Command+V] on Mac OS).
...
* https://github.com/spring-projects/spring-petclinic[Spring PetClinic Sample Application^] - open source sample application developed by the Spring Framework team to demonstrate the capabilities of Spring Boot, Spring MVC, and Spring Data Frameworks
