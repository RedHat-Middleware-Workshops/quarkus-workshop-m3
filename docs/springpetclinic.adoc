...
The project is imported into your workspace and is visible in the project explorer (collapse the _OPEN EDITORS_):
...
----
cd $CHE_PROJECTS_ROOT/quarkus-workshop-m3-labs && git checkout ocp-4.9
----
