...
To get started, {{ DS_URL }}#https://github.com/RedHat-Middleware-Workshops/quarkus-workshop-m3-labs/tree/ocp-4.19[access the Red Hat OpenShift Dev Spaces instance^] and select *Log in with OpenShift* button:
