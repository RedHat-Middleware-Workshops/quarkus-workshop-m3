...
Developing REST APIs with Quarkus is similar with using Spring Boot. Quarkus uses JAX-RS from the Microprofile specifications. Here's a comparison of common annotations used for REST development in Sprinboot and Quarkus:
